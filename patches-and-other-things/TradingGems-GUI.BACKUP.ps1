                    ...
                    <StackPanel>
                        ...
                        <GroupBox Header="📈 Item Distribution">
                            <Grid>
                                ...
                                <!-- Cheese -->
                                <TextBlock Grid.Row="2" Grid.Column="0" Text="🧀 Cheese" VerticalAlignment="Center"/>
                                <ProgressBar Grid.Row="2" Grid.Column="1" Name="barCheese" Minimum="0" Maximum="100"
                                             Value="0" Height="18" Foreground="#FFC83D"/>
                                <TextBlock Grid.Row="2" Grid.Column="2" Name="txtCheesePercent" Text="0%"
                                           VerticalAlignment="Center" HorizontalAlignment="Left" Margin="4,0,0,0"/>
                                <TextBlock Grid.Row="2" Grid.Column="3" Name="txtCheeseTotal" Text="0"
                                           VerticalAlignment="Center" HorizontalAlignment="Right"/>

                                <!-- Mulch -->
                                <TextBlock Grid.Row="3" Grid.Column="0" Text="🌿 Mulch" VerticalAlignment="Center"/>
                                <ProgressBar Grid.Row="3" Grid.Column="1" Name="barMulch" Minimum="0" Maximum="100"
                                             Value="0" Height="18" Foreground="#4D3925"/>
                                <TextBlock Grid.Row="3" Grid.Column="2" Name="txtMulchPercent" Text="0%"
                                           VerticalAlignment="Center" HorizontalAlignment="Left" Margin="4,0,0,0"/>
                                <TextBlock Grid.Row="3" Grid.Column="3" Name="txtMulchTotal" Text="0"
                                           VerticalAlignment="Center" HorizontalAlignment="Right"/>
...
@(
    ...
    'chkGem','chkBeer','chkMulch','chkCheese',
    ...
    'barGems','barBeer','barMulch','barCheese',
...
function Update-Statistics {
    ...
    try {
        ...
        $tradesPerHour = $script:stats.StartedTrades / $hours
        ...
        $highValueCount = $script:stats.GemValue10Count + $script:stats.GemValue11Count +
                          $script:stats.GemValue12Count + $script:stats.GemValue13Count
        ...
        $window.Dispatcher.Invoke([action]{
            ...
            $controls['txtTotalTrades'].Text   = $script:stats.StartedTrades
            ...
            $totalTrades = $script:stats.StartedTrades
            if ($totalTrades -gt 0) {
